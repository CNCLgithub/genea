...
We use the placeholder `<task>` to specify the task domain: use `bb` for block building and `nav` for navigation.
...
whereas those under the `library/fin_files` directory specify final block configurations.
...
### Run the model
All key model variables and parameters are defined in the [core_utils.py](https://github.com/CNCLgithub/genea/blob/main/mlr/share/projects/block_building/utils/core_utils.py) file, 
...
While the platforms themselves are created in Blender (see [blender_utils.py](https://github.com/CNCLgithub/genea/blob/main/mlr/share/projects/navigation/utils/blender_utils.py)), their configurations can be generated programmatically. Please refer to the [stimuli.py](https://github.com/CNCLgithub/genea/blob/main/mlr/share/projects/navigation/model/genea/stimuli.py) file in the navigation repository for examples.

### Run the model
All key model variables and parameters are defined in the [config_utils.py](https://github.com/CNCLgithub/genea/blob/main/mlr/share/projects/navigation/utils/config_utils.py) file, 
including the boolean constant `RUN_DYNAMICS` that, when set to `False`, runs the standard TAMP ablation model.
...
The output of the model is stored in the `library/out/model` directory. To generate a single CSV file compiling all the data generated by the model, run `ModelRunner.combine_results` in [main.py](https://github.com/CNCLgithub/genea/blob/main/mlr/share/projects/navigation/main.py).
...
- Goal and Action Inference: [https://github.com/CNCLgithub/genea-goal-action-psiturk.git](https://github.com/CNCLgithub/genea-goal-action-psiturk)
- Embodiment Strategies: [https://github.com/CNCLgithub/genea-hands-psiturk.git](https://github.com/CNCLgithub/genea-hands-psiturk)
- Navigation: [https://github.com/CNCLgithub/genea_nav_psiturk.git](https://github.com/CNCLgithub/genea_nav_psiturk)
