...
if [[ "$1" =~ "data" ]] || [[ "$1" =~ "all" ]];then
    ...
    wget --no-check-certificate "https://yaleedu-my.sharepoint.com/:u:/g/personal/aalap_shah_yale_edu/EU5kMTlcjEtJiT7VrRsJ85EBq7wzKnjrUVCwGi2rt6Gn4g?e=b3i0wh&download=1" -O library.zip
