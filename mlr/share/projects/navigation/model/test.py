...
RobotWrapper.BuildFromURDF(model_info.urdf_path, PathUtils.get_library_dir_path(), pinocchio.JointModelFreeFlyer())

icub = robotoc.Robot(model_info)


jump_length = np.array([.5, 0, 0])
flying_time = 2
ground_time = 0.7
...
plot_kkt.plot(kkt_data=kkt_data, ts_data=ts_data, fig_name="yay", save_dir=PathUtils.get_library_dir_path())
